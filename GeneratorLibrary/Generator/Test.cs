...
public class Test
{
    ...
    {
         //GptConnection gptConnection = new GptConnection("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");
         ...
         Tabs tab = Generator.NewTabs(positivePromt,negativePromt,"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");
         tab.Show();
    }
}